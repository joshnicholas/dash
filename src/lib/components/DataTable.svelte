			...
			<div class="max-h-96 overflow-y-scroll">
				<table class="w-full bg-white table-fixed">
					<thead class="bg-gray-50 sticky top-0">
						<tr>
							<th class="px-1 py-2 text-left text-xs font-medium text-gray-500 tracking-wider">Headline</th>
							{#if showPub}
								<th class="px-1 py-2 text-left text-xs font-medium text-gray-500 tracking-wider w-20">Publication</th>
							{/if}
